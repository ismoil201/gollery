...
import com.example.gollery.databinding.ItemFrameBinding
...
class FrameViewHolder(var binding: ItemFrameBinding): RecyclerView.ViewHolder(binding.root){


    fun bind(item: FrameItem){

        binding.fragmentImage.setImageURI(item.uri)
